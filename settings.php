...
if ($hassiteconfig) {
    $aimanagercategory = new admin_category(
    ...
    if ($ADMIN->fulltree) {
        $settings->add(
            new admin_setting_heading(
                'local_ai_manager/basicsettings',
                get_string('basicsettings', 'local_ai_manager'),
        ...
        $settings->add(
            new admin_setting_configmultiselect(
                'local_ai_manager/privilegedroles',
        ...
        $settings->add(
            new admin_setting_configcheckbox(
                'local_ai_manager/enablecleanuprequestlogtask',
    ...
    $aipurposessettingpage = new admin_settingpage(
        'aipurposepluginsmanagement',
        get_string('subplugintype_aipurpose_plural', 'local_ai_manager')
    );
    $aipurposessettingpage->add(
        new \core_admin\admin\admin_setting_plugin_manager(
            'aipurpose',
